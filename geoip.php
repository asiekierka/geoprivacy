<?php
  ...
  // + opt+out - user must opt-out and not opt-in
  ...
  // , Portugal
  $country_2 = array("AT","CY","FI","FR","GR","IT","LT","LV","LU","NL","PT","RO","SK","ES","SE");
  $country_1 = array("DK","PL","BE","BG","HU","IE","PL");
  $country_0 = array("CZ","EE","DE","MT","SI");
  $country_di = array("BE","BG","FR","PL");
  $country_oo = array("CZ","FI","IT");
  $country_sa = array("BE","DE");
  $country_val = 2;
